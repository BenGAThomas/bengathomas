    ...
    return (
        <section>
            <div className='flex flex-col items-center justify-center' >
                <h1 className="mt-16 overflow-hidden text-[6vw] font-semibold uppercase leading-none">
                    Benjamin <br /> Thomas
                </h1>
            {/* <img src='./pictures/atlutd_logo.png' alt='photo of Ben'></img> */}
            <div className="mt-8">
                <a href="./pictures/Benjamin Thomas Resume.pdf" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    download
                    className="flex items-center rounded-xl bg-green-500 p-2 px-3 font-sans font-medium text-black hover:bg-green-800"></a>
