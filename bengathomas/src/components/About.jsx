  ...
  return (
    <section id="about">
        ...
        <div className="flex items-center justify-center">
            <p className="m-1 max-w-6xl text-3xl lg:text-2xl">I am a Software Engineer located in Atlanta, GA. I specialize in creating responsive website and providing exceptional user experiences. I have a strong comprehension of front-end technologies. My skill set is in frameworks such as Javascript, React and Angular. I also have proficiency in SQL databases such as MongoDB, and Postgres. I am enthusiastic about learning new frameworks, libraries, and technology to help keep me up to date on the latest trends in building scalable, and great user friendly websites.</p>
        </div>
    </section>
  )
}
