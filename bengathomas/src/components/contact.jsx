...
const Contact = () => {
    ...
    <button onClick={() => window.location.href = 'mailto:Benjamingathomas@gmail.com'} className="my-4 text-center text-2xl font-medium text-red-500 lg:pt-6 lg:text-5xl" >Benjamingathomas@gmail.com</button>
